...
def main():
    startup_message()
    input("Press enter to say 'Who's There?'!")
    joke_delivery()
    input("Press enter to say 'Double who?'!")
    joke_delivery2()


def startup_message():
    print("This program tells a knock knock joke!")
    print("Knock Knock")
...
def area(r2):
    my_area = 3.14 * r2  # TODO insert the PI constant multiplied by the parameter here
...
def main7():
    ceil = math.ceil(number_to_round)
    print("The smallest integer greater than or equal to ", number_to_round, " is ", ceil)

...
def main():
    house = SingleFamilyHome('6', '1200 square feet', '1 floor', 'Single car garage', '.25 acres')
# 8) Display the data using the accessor methods
    print("Number of rooms: ", house.get_number_of_rooms())
    print("Square Feet: ", house.get_square_feet())
    print("Number of floors: ", house.get_floors())
    print("Type of Garage: ", house.get_garage_type())
    print("Yard Size: ", house.get_yard_size())

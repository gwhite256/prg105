...
class CrudGUI:
    def __init__(self, master):
        ...
        self.display = tkinter.Radiobutton(self.top_frame, text='Display SKU and description list',
        ...
        self.display.pack(anchor='w', padx=20)
...
class LookGUI:
    ...
    def search(self):
        ...
        result = self.inventory.get(name, 'Not Found')
...
class ChangeGUI:
    def __init__(self, master):
        ...
        self.look = tkinter.Toplevel(master)
        self.look.title('Enter a SKU and change the quantity')

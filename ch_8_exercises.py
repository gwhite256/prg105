...
if 'Jacob' in name:
    print("Jacob was found in the text.")
else:
    print("Jacob was not found in the text")
# 2) Test to see if the string "Michael" is in name, print the result
if 'Michael' in name:
    print("Michael is in the text")
else:
    print("Michael is not in the text")

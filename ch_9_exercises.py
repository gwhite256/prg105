...
birthdays = {'Meri': 'May 16', 'Kathy': 'July 14', 'Garrett': 'May 25', 'Anna': 'February 5', 'Rhys': 'November 24'}
...
remove = miles_ridden.pop('June 4')
print(miles_ridden)
...
days = {'Monday', 'Tuesday', 'Thursday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'}
